    ...
    <template v-if="activeCat === 'about'">
      ...
      <section class="copyright-section">
        ...
        <div class="copyright-card">
          ...
          <p class="copyright-text">
            Minecraft 相关名称、图案及商标归 Mojang Studios 与 Microsoft 所有。 本项目与 Mojang
            Studios 及 Microsoft 之间不存在任何关联关系。
          </p>
          <p class="copyright-text">
    ...
    <template v-else-if="activeCat === 'feedback'">
      ...
      <section class="feedback-section">
        <div class="feedback-card">
          ...
          <a href="https://github.com/nnkmn/MCLA/issues" target="_blank" class="feedback-btn"
            >前往 GitHub Issues</a
          >
        </div>
      ...
      <!-- 邮箱复制提示弹窗 -->
      <PxModal v-model="showEmailModal" title="提示" size="sm">
...
const credits = [
  {
    name: '龙腾猫跃',
    tag: '参考项目',
    desc: 'PCL2 作者。MCLA 参考了其部分内容和实现思路。',
    avatar: hexDragonAvatar
  },
  {
    name: 'StarLight.Core',
    tag: '核心参考',
    desc: '星光核心。MCLA 参考了其模块化架构设计理念和部分功能实现。',
